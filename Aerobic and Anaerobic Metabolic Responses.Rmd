...
temp <- c(24, 27, 30, 33)
RMR <- c(mean(RMR_24), mean(RMR_27), mean(RMR_30), mean(RMR_33))
RMR_err <- c(std.err(RMR_24), std.err(RMR_27), std.err(RMR_30), std.err(RMR_33))
MMR <- c(mean(MMR_24), mean(MMR_27), mean(MMR_30), mean(MMR_33))
MMR_err <- c(std.err(MMR_24), std.err(MMR_27), std.err(MMR_30), std.err(MMR_33))
AS <- c(mean(AS_24), mean(AS_27), mean(AS_30), mean(AS_33))
AS_err <- c(std.err(AS_24), std.err(AS_27), std.err(AS_30), std.err(AS_33))
...
RMR_MMR <- c(mean(RMR_24), mean(RMR_27), mean(RMR_30), mean(RMR_33), mean(MMR_24), mean(MMR_27), mean(MMR_30), mean(MMR_33))
RMR_MMR_err <- c(std.err(RMR_24), std.err(RMR_27), std.err(RMR_30), std.err(RMR_33), std.err(MMR_24), std.err(MMR_27), std.err(MMR_30), std.err(MMR_33))
...
hct_data
```
#How does aerobic scope and MMR change with chase time?
...
#anc_mmr2 <- aov(chase_tests$MMRs ~ #as.factor(chase_tests$temps)*chase_tests$chase_times)
#summary(anc_mmr2)
...
#anc_as2 <- aov(chase_tests$ASs ~ #as.factor(chase_tests$temps)*chase_tests$chase_times)
#summary(anc_as2)
